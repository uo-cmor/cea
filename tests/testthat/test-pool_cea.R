...
test_that("pool_cea works as expected", {
  ...
  expect_equal(fit_pooled$vcov, as.matrix(fit_fct$vcov))
  ...
  expect_equal(fit_pooled$pooled$t, diag(fit_pooled$vcov))
  expect_equal(fit_pooled$pooled$dfcom, rep(68, 15))
  expect_equal(fit_pooled$pooled$df, rep(66.084507, 15))
  expect_equal(fit_pooled$pooled$riv, rep(0, 15))
  expect_equal(fit_pooled$pooled$lambda, rep(0, 15))
  expect_equal(fit_pooled$pooled$fmi, rep(0.028950051, 15))
})
